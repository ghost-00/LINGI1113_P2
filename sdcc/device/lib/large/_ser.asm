...
_ser_getc_tmp_1_1:
	.ds 1
_ser_printString_String_1_1:
	.ds 3
_ser_charAvail_ret_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;tmp                       Allocated with name '_ser_getc_tmp_1_1'
;------------------------------------------------------------
...
;------------------------------------------------------------
;String                    Allocated with name '_ser_printString_String_1_1'
;------------------------------------------------------------
...
_ser_printString:
	...
	mov	r3,dph
	mov	a,dpl
	mov	dptr,#_ser_printString_String_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r3
	movx	@dptr,a
...
;------------------------------------------------------------
;ret                       Allocated with name '_ser_charAvail_ret_1_1'
;------------------------------------------------------------
...
;	_ser.c:148: char ret = 0;
	mov	dptr,#_ser_charAvail_ret_1_1
	clr	a
	movx	@dptr,a
