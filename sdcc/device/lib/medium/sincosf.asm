...
; This file was generated Wed Oct 23 12:25:46 2013
;--------------------------------------------------------
	.module sincosf
...
;------------------------------------------------------------
;	sincosf.c:40: float sincosf(const float x, const BOOL iscos)
;	-----------------------------------------
;	 function sincosf
;	-----------------------------------------
_sincosf:
